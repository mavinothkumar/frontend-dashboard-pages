...
if ( ! class_exists('FEDP_MainMenu')) {
    ...
    class FEDP_MainMenu
    {
            ...
            <div class="row padd_top_20">
                <div class="flex_between fed_pages_menu_item_container">
                    ...
                    <div class="col-md-7 fed_page_menu_item hide">
                        <?php wp_dropdown_pages(array('name' => 'fed_menu_value', 'class' => 'form-control')) ?>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        {
            wp_enqueue_script('fed_pages_script', plugins_url('/assets/fed_script_pages.js', FED_PAGES_PLUGIN),
                array());
        }
    }
